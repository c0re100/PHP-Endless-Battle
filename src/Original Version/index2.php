...
$VERSION = "<span onmouseover=\"this.style.cursor='hand';window.status='php-eb 官方網站';\" onmouseout=\"window.status=''\" onClick=\"window.open('http://v2alliance.no-ip.org')\">php-eb Version ". $cSpec ."</span>";
if ($vBdNum) $VERSION .= "　&nbsp;&nbsp;&nbsp;&nbsp;<br><font style='font-size: 10px'>Build ". $vBdNum ."</font>";
if ($sSpec) $VERSION .= "　&nbsp;&nbsp;&nbsp;&nbsp;<br><span style='font-size: 10px' onmouseout=\"window.status=''\" onmouseover=\"this.style.cursor='hand';window.status='網主 \'".$WebMasterName."\' 的網站'\" onClick=\"window.open('".$WebMasterSite."')\">". $sSpec ."</span>";
