...
if ($mode == 'weplist'){
        ...
        echo "<form action=gen_info2.php?action=weplist method=post name=searchwepform>";
...
if ($mode == 'mslist'){
        ...
        echo "<div align=center><form action=gen_info2.php?action=mslist method=post name=searchmsform><select name=SearchField[Name]>";
        do
        {
