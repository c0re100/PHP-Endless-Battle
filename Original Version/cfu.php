...
$sSpec = 'Official Version';				//其他版本資訊, 這項可自由修改
$WebMasterName = '風之翎';				//網主名稱
...
$DBPass = '';			//資料庫密碼
$DBName = '';			//資料庫名稱
$DBPrefix = 'vsqa_';		//資料表前綴名, 安裝前請冒必更改!! 安裝後不能再更改!!
...
$Move_Intv = 60;		//移動等待時間, 若版圖大的話, 可以設少一點, 但請注意國戰時工廠的使用
...
//組織相關設定
$OrganizingCost = '1000000';	//建立組織價錢
$OrganizingFame = '25';		//建立組織所需要名聲 -- 名聲高和惡名高也可以建立組織
$OrganizingNotor = '-50';	//建立組織所需要惡名 (需為負數) -- 名聲高和惡名高也可以建立組織 
...
//格納庫相關設定
$Hangar_Price = 400000;		//格納庫寄存價錢(每次記存), 如出現濫用的情況, 請加價...
...
$TFDCostCons = 20000;		//購買合成方法的價錢系數, 公式: [2^(級數)]*價錢系數
...
global $RightsClass;
$RightsClass = array("Major" => '主席',"Leader" => '隊長');
...
function postFooter(){
	...
	echo "<p align=center style=\"font-size: 10pt\">&copy; 2005-2006 v2Alliance. All Rights Reserved.　版權所有 不得轉載<br>";
...
if(ereg('(MirrorDam)+',$Specs))$SpecsTag .='鏡<br>';
